...
namespace EnrolmentSystem.StudentDataSetTableAdapters {
    ...
    public partial class StudentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["StudentEnrolmentDBConnectionString"].ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@StudentName", global::System.Data.SqlDbType.NVarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "StudentName", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int FillBy(StudentDataSet.StudentsDataTable dataTable, string StudentName) {
        ...
        public virtual StudentDataSet.StudentsDataTable GetDataByStudentName(string StudentName) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((StudentName == null)) {
                throw new global::System.ArgumentNullException("StudentName");
            }
        ...
        public virtual int Insert(string StudentName, string DateEnrolled) {
            ...
            if ((DateEnrolled == null)) {
                throw new global::System.ArgumentNullException("DateEnrolled");
            }
            else {
    ...
    public partial class CoursesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            this._connection = new global::System.Data.SqlClient.SqlConnection();
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["StudentEnrolmentDBConnectionString1"].ConnectionString;
        }
